...
buildscript {
    ...
    dependencies {
        ...
        classpath("org.codingfeline.buildkonfig.buildkonfig-gradle-plugin:0.15.1")
    }
}
...
subprojects {
    ...
    cloudstream {
        ...
        setRepo(System.getenv("GITHUB_REPOSITORY") ?: "https://github.com/ulangsiar/CS3-Extensions-kodim")
    }
